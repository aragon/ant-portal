...
const networks = new Map<EnvNetworkName, EnvNetworkConfig>([
  ...
  [
    'rinkeby',
    {
      ...
      ipfsGateway: 'https://ipfs.eth.aragon.network/ipfs',
      contracts: {
        tokenAntV1: '0xD729df29f5bc7FD40Acc4c411BEf6b0A8b30Fb01',
        tokenAntV2: '0xfB330755FdfA8DFb8EE3c399Ee041ca3C98237a1',
        migrator: '0x2d6E2542Ee753E2936e4BD9ba322429eAd13CE84',
        tokenAnj: '0xb587282129Da84C3Cfd15f03A824275DB16d0aa3',
        anjMigrator: '0x3F84C0Fcab7feA519D887c14715e0b9606d9bb4D',
      },
    },
  ],
])
